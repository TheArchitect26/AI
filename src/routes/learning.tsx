...
export const Route = createFileRoute("/learning")({
  head: () => ({
    meta: [
      { title: "AI Learning Center — NEXUS" },
      { name: "description", content: "Pattern evolution, confidence, regime mastery" },
    ],
  }),
  component: Page,
});
      ...
      <GlassPanel className="relative overflow-hidden p-6" scanline>
        ...
        <div className="relative">
          <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-neon-cyan">
            <StatusDot pulse /> Adaptation
          </div>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight md:text-3xl">AI Learning Center</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">Pattern evolution, confidence, regime mastery</p>
        </div>
      </GlassPanel>
