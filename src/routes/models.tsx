...
export const Route = createFileRoute("/models")({
  head: () => ({
    meta: [
      { title: "Model Manager — NEXUS" },
      { name: "description", content: "Llama, Qwen, DeepSeek, Mistral · benchmarks & VRAM" },
    ],
  }),
  component: Page,
});
      ...
      <GlassPanel className="relative overflow-hidden p-6" scanline>
        ...
        <div className="relative">
          <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-neon-cyan">
            <StatusDot pulse /> Local models
          </div>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight md:text-3xl">Model Manager</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">Llama, Qwen, DeepSeek, Mistral · benchmarks & VRAM</p>
        </div>
      </GlassPanel>
