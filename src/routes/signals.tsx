...
export const Route = createFileRoute("/signals")({
  head: () => ({
    meta: [
      { title: "Signal Engine — NEXUS" },
      { name: "description", content: "Multi-timeframe AI setups with risk meters" },
    ],
  }),
  component: Page,
});
      ...
      <GlassPanel className="relative overflow-hidden p-6" scanline>
        ...
        <div className="relative">
          <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-neon-cyan">
            <StatusDot pulse /> Edge generation
          </div>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight md:text-3xl">Signal Engine</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">Multi-timeframe AI setups with risk meters</p>
        </div>
      </GlassPanel>
