...
export const Route = createFileRoute("/research")({
  head: () => ({
    meta: [
      { title: "Research Hub — NEXUS" },
      { name: "description", content: "Article ingest, AI summaries, source compare" },
    ],
  }),
  component: Page,
});
      ...
      <GlassPanel className="relative overflow-hidden p-6" scanline>
        ...
        <div className="relative">
          <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-neon-cyan">
            <StatusDot pulse /> Intelligence
          </div>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight md:text-3xl">Research Hub</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">Article ingest, AI summaries, source compare</p>
        </div>
      </GlassPanel>
