...
export const Route = createFileRoute("/scanner")({
  head: () => ({
    meta: [
      { title: "Market Scanner — NEXUS" },
      { name: "description", content: "Live universe scan with confidence ranking" },
    ],
  }),
  component: Page,
});
      ...
      <GlassPanel className="relative overflow-hidden p-6" scanline>
        ...
        <div className="relative">
          <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-neon-cyan">
            <StatusDot pulse /> Discovery
          </div>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight md:text-3xl">Market Scanner</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">Live universe scan with confidence ranking</p>
        </div>
      </GlassPanel>
