...
export const Route = createFileRoute("/automation")({
  head: () => ({
    meta: [
      { title: "Automation Workflows — NEXUS" },
      { name: "description", content: "Drag-and-drop AI pipelines" },
    ],
  }),
  component: Page,
});
      ...
      <GlassPanel className="relative overflow-hidden p-6" scanline>
        ...
        <div className="relative">
          <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-neon-cyan">
            <StatusDot pulse /> Node graph
          </div>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight md:text-3xl">Automation Workflows</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">Drag-and-drop AI pipelines</p>
        </div>
      </GlassPanel>
