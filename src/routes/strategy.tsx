...
export const Route = createFileRoute("/strategy")({
  head: () => ({
    meta: [
      { title: "Strategy Lab — NEXUS" },
      { name: "description", content: "Build, test, and optimize strategies" },
    ],
  }),
  component: Page,
});
      ...
      <GlassPanel className="relative overflow-hidden p-6" scanline>
        ...
        <div className="relative">
          <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-neon-cyan">
            <StatusDot pulse /> Research & backtest
          </div>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight md:text-3xl">Strategy Lab</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">Build, test, and optimize strategies</p>
        </div>
      </GlassPanel>
